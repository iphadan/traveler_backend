"""
Django settings for traveler_backend project.
...
SECRET_KEY = 'django-insecure-t8*9vdb^@f8s$&!(qxh8gcpy&k+=@^t$l*4npb-&kb0e7&gtg)'
...
ROOT_URLCONF = 'traveler_backend.urls'
...
WSGI_APPLICATION = 'traveler_backend.wsgi.application'
